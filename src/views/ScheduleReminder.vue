  ...
  <div class="wrapper">
    ...
    <div class="page-header">
      <div class="header-content">
        ...
        <p class="subtitle">Jadwalkan pengiriman pesan yang berulang secara otomatis berdasarkan interval waktu yang Anda tentukan. Waktu akan dikirim sesuai persis dengan input Anda.</p>
      </div>
    </div>
        ...
        <div class="card-body">
          ...
          <div v-else class="device-selector-empty">
            ...
            <div class="empty-text">
              ...
              <p>Pilih device yang akan digunakan untuk mengirim broadcast berulang</p>
            </div>
          </div>
          ...
          <div class="form-row">
            ...
            <div class="form-group">
              ...
              <small class="help-text">
                ...
                Setiap berapa {{ form.recurrence === 'minute' ? 'menit' : form.recurrence === 'hourly' ? 'jam' : form.recurrence === 'daily' ? 'hari' : form.recurrence === 'weekly' ? 'minggu' : 'bulan' }}
              </small>
            </div>
