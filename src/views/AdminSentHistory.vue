<template>
  <div class="wrapper">
    ...
    <section class="list-card">
      ...
      <div class="toolbar-section">
        ...
        <div class="filter-group">
          ...
          <select v-model="sortDir" class="filter-select compact">
            <option value="desc">↓ Turun</option>
            <option value="asc">↑ Naik</option>
          </select>

          <button class="btn-filter" @click="load(1)" :disabled="loading">
            {{ loading ? "..." : "Cari" }}
          </button>
      ...
      <div class="table-container">
        <table class="custom-table" v-if="!loading && displayedRows.length > 0">
          <thead>
            <tr>
    ...
    <div v-if="showConfirm" class="delete-modal-overlay" @click="cancelConfirm">
      <div class="delete-modal" @click.stop>
        ...
        <div class="delete-modal-content">
          <h3>{{ confirmTitle }}</h3>
          <p class="delete-warning">{{ confirmMessage }}</p>
        </div>
